...
This resolves the "Eliza, Sarah, and Alfred unaccounted for" note from 14 July — all three, plus the additional child Elizabeth/"Eliza" herself, are now confirmed dead via primary burial records, not missing. **Cause of death, 1844–47 Ansell deaths**: not stated in any burial record obtained. Scarlet fever, diphtheria, and typhus are noted in Chapter 2's prose as diseases known to have moved through Essex villages in this period — this is general historical context, not a documented cause for these specific deaths, and should not be upgraded to fact without a source that actually names a cause for one of these entries.
