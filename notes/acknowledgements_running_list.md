...
- **Kasia Ferguson.** Took a MyHeritage DNA test for the project. Recorded: project memory. *Rik to decide
  whether this belongs under help with the research or in a personal note.*

### DNA matches and descendants
- **Bronwyn Joule**, descendant of Eliza Jane Madams (emigrated to New Zealand, 1927). The MyHeritage match,
  found 10 September 2026, that confirms the Stock/Gouldstone/Madams chain genetically. Recorded:
  `notes/rik_voice_elizabeth_22sep2026.md`. *Contact status to confirm; letter drafted.*
...
- **Mark Lewis.** The grave number, 1370A, and the burial entry wording, including "2 males unnamed".
  Recorded: timeline file, "The grave number — 1370A".
- **Karen McGowan-Griffin**, who lived in the cemetery lodge from the early 1960s to the early 1980s. The
  office attached to the lodge with its own entrance, and the later mortuary at the back of the car park.
  Recorded: timeline file, "The lodge, the board room and the mortuary".
- **Lizzie Harper.** The coroner's court at the entrance on Queens Road. Same entry.
- **The group itself**, for the two undated photographs of the chapel and the lodge and gates
  (`sources/images/Queens_Road_Cemetery_*`). *Find out who posted them and where the lodge photograph was
  printed; credit the original source if found.*

### Local historians whose published work was used
- **Bryn Elliott**, "Walthamstow Police Station" (brynelliott.co.uk). Lea Bridge Road station history, Chapter
  Nine. Recorded: MASTER_NOTES, Chapter Nine session.
...
- **The National Archives**: CRIM 1/19/2 (the depositions, witness statements, committal and Home Office
  letter).
- **Royal Berkshire Archives**: the 1935 inquest papers, COR/R1/7/3/1-4, and the Broadmoor records.
- **Essex Record Office**: parish registers and deeds (Great Sampford, Thaxted, Wethersfield, Walthamstow).
...
- **Met Office** Daily Weather Reports (digitised), with the transcription by Craig and Hawkins (2024), if
  weather data is used in the finished text.
...
- **Waltham Forest Archives / Vestry House Museum**: enquiry drafted
  (`correspondence/DRAFT_archives_and_historical_society_enquiries.md`).
