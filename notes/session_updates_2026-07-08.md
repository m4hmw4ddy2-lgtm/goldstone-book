# SESSION UPDATES — 8 JULY 2026
## For manual merge into MASTER_NOTES_7_JULY_2026.md and confirmed_facts_timeline_contradictions.md

---

## 1. PROLOGUE — FINAL TEXT (replaces "Part Two: The Prologue — Current Text" in MASTER_NOTES)
...
## 2. PROLOGUE DECISIONS — updated list (replaces prior bullet list in MASTER_NOTES)
...
## 3. CONFIRMED FACTS — additions to confirmed_facts_timeline_contradictions.md

### New entries for THE SEQUENCE OF EVENTS table (item 7, chair/cistern)

| Fact | Source |
|---|---|
| William Gouldstone was within hearing when Ada asked who had moved the chair, and did not answer | Ada Hamilton, coroner deposition — verbatim quote below |
| Verbatim: "I then went into the scullery and noticed that the perambulator had been moved from [word crossed out] near to the cistern and a chair put in its place. I asked as to who had placed the chair there. William Gouldstone was within hearing. Charles Gouldstone replied 'My Daddy put it there.'" | Ada Hamilton, coroner deposition |
| Manuscript note: a word is crossed out in the original before "near to the cistern" — paleographic detail, not a transcription gap. Content of the cancelled word not yet established. | Coroner deposition, physical manuscript |

### New entry for THE HAMILTONS / BEDROOM DOORWAY sequence

| Fact | Source |
|---|---|
| Verbatim, Ada to William at the bedroom door: "You can come in Mr Goldstone" (deposition's own spelling of the surname at this instance) | Ada Hamilton, coroner deposition |
| Cross-reference: witness statement (CRIM 1/19/2) paraphrases this as "I told him he could come in," without direct quotation or surname | Ada Hamilton, witness statement |

### New entry for THE CORD/CLOTHESLINE

| Fact | Source |
|---|---|
| Verbatim: "I noticed he had a piece of clothes line in his hand tying it. The piece produced is either the same or similar to it." | Ada Hamilton, coroner deposition |

### Resolution note for Open Question 7 ("Chair-moving by Ada")

Distinguish two separate claims that were previously at risk of being conflated:
- Ada **noticing** the chair placed at the cistern and questioning who moved it — CONFIRMED, sworn, multiple sources including the coroner deposition verbatim above.
- Ada **moving the chair back** afterward — remains press-only (DT 10 Aug, Western Times 14 Aug), not in any sworn primary document. Still unconfirmed. Do not use.

---

## 4. OPEN QUESTION STATUS

No open questions resolved this session beyond the above. The crossed-out word in the coroner deposition (Section 3) is a new, minor open question: what was cancelled before "near to the cistern"? Low priority — cosmetic, doesn't affect the established sequence.

---

*Session conducted 8 July 2026. Prologue status: SETTLED, pending Rik's final read.*
